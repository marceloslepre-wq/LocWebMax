  ...
  var calculateOverdueFees = function (rentalRec, daysOverdue, tenantId) {
    ...
    for (var k = 0; k < rentalItems.length; k++) {
      ...
      if (inv) {
        ...
        // Se no produto daily_price estiver zerado, tenta obter de monthly_price / 30
        if (dPrice <= 0) {
    ...
    // Se nenhum item teve valor diário real resolvido no Estoque, NÃO inventar valor fixo genérico
