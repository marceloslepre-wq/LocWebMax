...
migrate(
  (app) => {
    ...
    // - REGRA 3 ajustada: o canal de WhatsApp é o canal geral de atendimento da loja (Hospital Home).
    //   NUNCA afirmar que "este canal é exclusivo".
    // - Se a conversa for sobre novas locações, orçamentos avulsos, compras ou dúvidas gerais, orientar
    //   com o novo texto amigável de direcionamento à equipe da loja.
    // - Para saudações puras ou mensagens sem relação com contratos vencendo/vencidos, a assistente não deve intervir.
...
REGRA 3 - ESCOPO, DIRECIONAMENTO E CANAL DE ATENDIMENTO:
